    ...
    <div class="col-12 col-md-8 col-lg-6 bodyform p-4 rounded-4 shadow">
      ...
      <form class="row g-3">
        ...
        <div class="col-12 text-center">
          <button type="button" class="btn btn-golden w-100 btn-lg shadow-sm" @click="editNSX()">Lưu</button>
        </div>
...
export default {
  ...
  methods: {
    ...
    editNSX(){
        axios.post('http://localhost:8000/suansx/',{
            _id:this._id,
            nsx_ma:this.nsx_ma,
  ...
  created(){
    ...
    this.nsx_ma=this.$route.query.nsx_ma;
    this.nsx_ten=this.$route.query.nsx_ten;
    this.nsx_diachi=this.$route.query.nsx_diachi;
    this.nsx_sdt=this.$route.query.nsx_sdt;
  }
}
</script>
