            ...
            <div class="card h-60 text-center">
              ...
              <div class="card-body d-flex flex-column">
                <p class="card-text text-center">
                  <span class="h3 text-warning">{{ sp.sp_dongia.toLocaleString('vi-VN') }}đ</span>
                </p>
                ...
                <div class="d-grid gap-2 mt-auto justify-content-center">
                  <a href="#" class="btn btn-warning about" @click="gotoChitietsp(sp.id)">
...
<script>
import Footers from '@/components/Menu/Footers.vue'
...
export default {
  ...
  methods: {
    ...
    async dssanpham(){
      await axios.post('http://localhost:8000/timkiemsanpham',{
        keyword:this.key
      })
        .then(async(response) => {
