    ...
    <div class="col-12 col-md-8 col-lg-6 bodyform p-4 rounded-4 shadow">
      ...
      <form class="row g-3">
        ...
        <div class="col-12 text-center">
          <button type="button" class="btn btn-golden w-100 btn-lg shadow-sm " @click="editloai()">Lưu</button>
        </div>
...
export default {
  ...
  methods: {
    ...
    editloai(){
        axios.post('http://localhost:8000/sualoai/',{
            _id:this._id,
  ...
  created(){
    ...
    this.loai_ma=this.$route.query.loai_ma;
    this.loai_tenloai=this.$route.query.loai_ten;
  }
}
</script>
